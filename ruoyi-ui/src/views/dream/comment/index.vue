<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="被回复用户ID" prop="replyToUserId">
        <el-input
      ...
      <el-form-item label="评论点赞数" prop="likeCount">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['dream:comment:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['dream:comment:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="commentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户上传的图片URL" align="center" prop="imageUrls" />
      <el-table-column label="父评论ID" align="center" prop="parentId" />
      <el-table-column label="被回复用户ID" align="center" prop="replyToUserId" />
      <el-table-column label="评论点赞数" align="center" prop="likeCount" />
      <el-table-column label="0-正常，1-删除" align="center" prop="isDeleted" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['dream:comment:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['dream:comment:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="commentRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="用户上传的图片URL" prop="imageUrls">
        ...
        <el-form-item label="被回复用户ID" prop="replyToUserId">
          <el-input v-model="form.replyToUserId" placeholder="请输入被回复用户ID" />
        </el-form-item>
        <el-form-item label="评论点赞数" prop="likeCount">
          <el-input v-model="form.likeCount" placeholder="请输入评论点赞数" />
        </el-form-item>
      </el-form>
      <template #footer>
...
import { listComment, getComment, delComment, addComment, updateComment } from "@/api/dream/comment"
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除博客评论编号为"' + _ids + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('dream/comment/export', {
    ...queryParams.value
