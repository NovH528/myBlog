<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['dream:folder:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['dream:folder:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="folderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文件夹ID" align="center" prop="id" />
      <el-table-column label="所属用户" align="center" prop="userId" />
      <el-table-column label="文件夹名称" align="center" prop="name" />
      <el-table-column label="父文件夹ID" align="center" prop="parentId" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['dream:folder:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['dream:folder:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="folderRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="父文件夹ID" prop="parentId">
          <el-input v-model="form.parentId" placeholder="请输入父文件夹ID" />
        </el-form-item>
      </el-form>
      <template #footer>
...
import { listFolder, getFolder, delFolder, addFolder, updateFolder } from "@/api/dream/folder"
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除收藏文件夹编号为"' + _ids + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('dream/folder/export', {
    ...queryParams.value
